          ...
          <div className="mt-12 grid gap-14 lg:grid-cols-12 lg:gap-20">
            ...
            <div className="lg:col-span-5">
              ...
              <h1 className="font-display text-[clamp(2.5rem,5.5vw,4.5rem)] leading-[0.94] tracking-tight">
                ...
                <span className="block text-white/65"><LocalizedText uz="qoldiring." ru="обращение." en="an inquiry." /></span>
              </h1>
                  ...
                  return (
                    <a
                      ...
                      <span className="min-w-0 flex-1">
                        <span className="block font-mono text-[11px] uppercase tracking-[0.18em] text-white/35">
