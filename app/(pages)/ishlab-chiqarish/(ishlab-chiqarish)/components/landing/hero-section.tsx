...
export function HeroSection() {
  ...
  const copy = getProductionContent(locale).hero;
    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          {/*
            WebM manbasi ATAYLAB olib tashlangan. U 4K VP9 da 33 MB edi va
            brauzer birinchi qo'llab-quvvatlangan manbani oladi — ya'ni Chrome
            aynan o'sha 33 MB ni yuklardi. Qayta kodlashda VP9 hech qanday
            sozlamada H.264 dan yaxshi natija bermadi (eng yaxshisi 6.1 MB,
            H.264 esa 3.5 MB). `<video>` tegini qo'llab-quvvatlaydigan barcha
            brauzerlar H.264 ni o'qiydi.
          */}
        ...
        <div
          ...
          style={{
            boxShadow: "inset 0 0 180px 90px rgba(0, 0, 0, 0.82)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 w-full max-w-350 mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="lg:max-w-[55%]">
          ...
          <div
            ...
            <span className="inline-flex items-center gap-3 text-base font-mono text-white/60">
      ...
      <div
        ...
        <div className="max-w-350 mx-auto flex items-start gap-10 lg:gap-20">
          {[
            { value: "35+", label: copy.stats[0] },
            { value: "100%", label: copy.stats[1] },
