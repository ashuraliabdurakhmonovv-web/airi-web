...
import UzInstituteInstituteteamPage from "@/app/(pages)/umumiy-malumot/(umumiy-malumot)/(institute)/institute-instituteteam/page";

const PATH = "/umumiy-malumot/institute-instituteteam";
const LOCALE = "ru";
